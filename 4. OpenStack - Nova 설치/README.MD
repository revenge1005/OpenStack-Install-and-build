...
#### (1) 설치
```
apt install qemu-kvm libvirt-daemon-system libvirt-clients virtinst bridge-utils nova-compute-kvm python-openstackclient nova-api-metadata nova-compute python3-novaclient -y
```
